...
import { playIntro, playApiSaved } from "../audio/audio.js";
...
export function initIntro(onReady) {
  ...
  // Click-to-begin gate — ensures a user gesture before intro.mp3 plays
  let began = false;
  function handleBeginClick() {
    if (began) return;
    began = true;
    overlay.removeEventListener("click", handleBeginClick);
  ...
  overlay.addEventListener("click", handleBeginClick);
